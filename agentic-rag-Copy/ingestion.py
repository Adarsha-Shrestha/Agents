...
distributed_docs = PyPDFLoader(r"C:\Users\admin\Downloads\7th sem\3. Distributed Systems\manual book pdf version.pdf").load()
split_distributed_docs = splitter.split_documents(distributed_docs)

# Add metadata
for doc in split_distributed_docs:
    doc.metadata = doc.metadata or {}
    doc.metadata["subject"] = "Distributed"
    
all_docs = split_data_docs + split_network_docs + split_distributed_docs
...
# Only run this once to upload documents
