...
- Distributed: Distributed systems and cloud computing concepts
...
question_router = {"question": RunnablePassthrough(), "subject": RunnablePassthrough()} | route_prompt | structured_llm_router
